...
Public Class Form6
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Next
        Dim fs As New FileStream("E:\CC\PROJET\Donnateurs.txt", FileMode.Create, FileAccess.Write)
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        For i = 0 To DataGridView1.Rows.Count - 1
            ...
            sr.WriteLine(val1 + "#" + val2 + "#" + val3 + "#" + val4 + "#" + val5 + "#" + Date.Now.Date)
    ...
    Private Sub Button77_Click(sender As Object, e As EventArgs) Handles Button77.Click
        ...
        End If
        If mnt = 0 Or mnt = "" Then
            MsgBox("Verifier le montant", vbCritical, "Erreur")
            ok = False

        End If
        If ok = True Then
            Dim ff As New FileStream("E:\CC\PROJET\Donnateurs.txt", FileMode.Append, FileAccess.Write)
            Dim sw As New StreamWriter(ff)
            sw.WriteLine(cin + "#" + np + "#" + tel + "#" + adresse + "#" + mnt + "#" + Date.Now.Date)
            sw.Close()
            ff.Close()
