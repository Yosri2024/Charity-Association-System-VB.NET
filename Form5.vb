...
Public Class Form5
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Dim fs As New FileStream("E:\CC\PROJET\Participants.txt", FileMode.Open, FileAccess.Read)
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Next
        Dim fs As New FileStream("E:\CC\PROJET\Participants.txt", FileMode.Create, FileAccess.Write)
    ...
    Private Sub Button77_Click(sender As Object, e As EventArgs) Handles Button77.Click
        ...
        End If
        If ok = True Then
            Dim ff As New FileStream("E:\CC\PROJET\Participants.txt", FileMode.Append, FileAccess.Write)
